...
namespace SFA.DAS.RAA_V2.Service.Project.Tests.Pages
{
    ...
    {
        protected override string PageTitle => IsTraineeship ? "What is the expected career progression after this traineeship?" : (isRaaV2Employer ? "What is the expected career progression after this apprenticeship?" : "What is the expected career progression after this apprenticeship?");
