...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("I want to be able to Add Apprenticeships to the Favourite Short List", null, new string[] {
                        "campaign",
                        "regression"});
#line 8
