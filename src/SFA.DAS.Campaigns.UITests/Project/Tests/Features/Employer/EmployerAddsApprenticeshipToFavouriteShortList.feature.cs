...
namespace SFA.DAS.Campaigns.UITests.Project.Tests.Features.Employer
{
    ...
    [NUnit.Framework.DescriptionAttribute("EmployerAddsApprenticeshipToFavouriteShortList")]
    public partial class EmployerAddsApprenticeshipToFavouriteShortListFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "EmployerAddsApprenticeshipToFavouriteShortList.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-GB"), "EmployerAddsApprenticeshipToFavouriteShortList", "\tAs an Employer\r\n\tI want to be able to navigate to Fire It Up home page\r\n\tSo that" +
        ...
        [NUnit.Framework.DescriptionAttribute("I want to be able to Add Apprenticeships to the Favourite Short List")]
        public virtual void IWantToBeAbleToAddApprenticeshipsToTheFavouriteShortList()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("I want to be able to Add Apprenticeships to the Favourite Short List", null, ((string[])(null)));
#line 6
...
#line 14
 testRunner.Then("I Can Verify the Favourite Count", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
