...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("CA_EMP_08_Check Choose a training provider Page Details", null, new string[] {
                        "campaigns",
                        "employer",
                        "regression"});
#line 6
