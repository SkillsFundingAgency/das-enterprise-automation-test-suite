Feature: RegisterMyInterestEmployer
	As a user
...
@campaigns
@regression
Scenario: Employer Wants To Register My Interest on The Fire It Up Site
	Given I navigate to Fire It Up home page
	And I Click On The Register My Interest Button
	And I Enter My First Name, Last Name And Email
	And I Tick The Radio Button For I Want toEmploy An Apprentice
