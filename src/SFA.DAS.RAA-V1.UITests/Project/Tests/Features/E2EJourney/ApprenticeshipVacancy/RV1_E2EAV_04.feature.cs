...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-GB"), "Project/Tests/Features/E2EJourney/ApprenticeshipVacancy", "RV1_E2EAV_04", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void RV1_E2EAV_04_CreateAnOfflineApprenticeshipVacancyAndApprove(string location, string anonymity, string disabilityConfident, string applicationMethod, string apprenticeshipType, string hoursPerWeek, string vacancyDuration, string changeteam, string changeRole, string noOfPositions, string qualificationDetails, string workExperience, string trainingCourse, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("RV1_E2EAV_04 - Create an Offline Apprenticeship Vacancy and Approve", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
