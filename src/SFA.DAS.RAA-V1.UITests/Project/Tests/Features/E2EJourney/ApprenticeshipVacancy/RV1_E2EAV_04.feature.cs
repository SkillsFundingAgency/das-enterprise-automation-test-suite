...
#line hidden
        ...
        public virtual void RV1_E2EAV_04_CreateAnOfflineApprenticeshipVacancyAndMakeItInProgress(string location, string anonymity, string disabilityConfident, string applicationMethod, string apprenticeshipType, string hoursPerWeek, string vacancyDuration, string changeteam, string changeRole, string noOfPositions, string qualificationDetails, string workExperience, string trainingCourse, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("RV1_E2EAV_04 - Create an Offline Apprenticeship Vacancy and make it In progress", null, @__tags);
#line 7
...
#line 15
 testRunner.Then("Provider can to make the application to be \'In progress\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("RV1_E2EAV_04 - Create an Offline Apprenticeship Vacancy and make it In progress: " +
        ...
        public virtual void RV1_E2EAV_04_CreateAnOfflineApprenticeshipVacancyAndMakeItInProgress_UseTheMainEmployerAddress()
        {
#line 7
this.RV1_E2EAV_04_CreateAnOfflineApprenticeshipVacancyAndMakeItInProgress("Use the main employer address", "No", "No", "Offline", "Framework", "42", "52", "West Midlands", "Vacancy reviewer", "2", "Yes", "Yes", "Yes", ((string[])(null)));
#line hidden
        }
    }
}
