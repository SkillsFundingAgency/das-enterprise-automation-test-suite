...
{
    [Binding]
    public class CoursesApiSteps(ScenarioContext context)
    {
        private readonly Inner_CoursesApiRestClient _innerApiRestClient = context.GetRestClient<Inner_CoursesApiRestClient>();
