...
{
    public abstract class EmploymentChecksFunctionAppHelper
    {
        ...
        protected EmploymentChecksFunctionAppHelper(EmploymentChecksProcessConfig config)
        {
            BaseUrl = config.EmployerChecksAppBaseUrl;
            AuthenticationCode = config.EmploymentChecksAppCode;
