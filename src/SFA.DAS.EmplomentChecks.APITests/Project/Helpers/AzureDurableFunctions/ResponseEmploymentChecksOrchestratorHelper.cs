...
public class ResponseEmploymentChecksOrchestratorHelper(ScenarioContext context)
{
    private readonly EmploymentCheckOrchestrationHelper _checkOrchestrationHelper = context.Get<EmploymentCheckOrchestrationHelper>();
