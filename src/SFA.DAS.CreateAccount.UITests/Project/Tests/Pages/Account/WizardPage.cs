...
namespace SFA.DAS.CreateAccount.UITests.Project.Tests.Pages.Account
{
    class WizardPage : BasePage
    {
        ...
        private By _title = By.XPath("//*[@id=\"welcome\"]/h1");
        private By _description = By.XPath("//*[@id=\"welcome\"]/p");
        private By _topRightCloseOption = By.XPath("//span[contains(text(), 'Close')]");
        private By _step1AddPayeSchemesNowLink = By.XPath("//div[contains(@id, 'add-paye-schemes-guide')]/a[contains(text(), 'Add PAYE schemes now')]");
        private By _step1YesOptionText = By.XPath("//div[contains(@id, 'add-paye-schemes-guide')]");
        private By _step2AddOrganisationsNowLink = By.XPath("//div[contains(@id, 'guide-wizard-step-organisations')]/a[contains(text(), 'Add organisations now')]");
        private By _step3InviteColleaguesFromMyOrganisationNowLink = By.XPath("//div[contains(@id, 'guide-wizard-step-members')]/a[contains(text(), 'Invite colleagues from my organisation now')]");
