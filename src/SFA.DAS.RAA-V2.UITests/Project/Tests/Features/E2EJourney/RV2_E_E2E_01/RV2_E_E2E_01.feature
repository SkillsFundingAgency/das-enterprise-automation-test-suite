...
When the Applicant can apply for the vacancy
Then Employer is able to view and make the application 'Successful'
And the Application status should be 'Successful'
