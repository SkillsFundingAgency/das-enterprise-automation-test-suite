...
namespace SFA.DAS.ApprenticeRedundancy.UITests.Project.Test.StepDefinitions
{
    ...
    public class ApprenticeSteps
    {
        ...
        public void GivenTheApprenticeLandsOnApprenticeDetailsForm()  => new NewApprenticeshipLandingPage(_context).SelectAprpenticesStartnow().CompleteApprenticeDetails();
