...
namespace SFA.DAS.Approvals.UITests.Project.Tests.Pages.Employer
{
    ...
    public class PaymentsResumedConfirmationPage(ScenarioContext context) : ConfirmApprenticeStatus(context)
    {
        protected override string PageTitle => "Payments resumed";
