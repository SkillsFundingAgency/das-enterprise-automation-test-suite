...
namespace SFA.DAS.Approvals.UITests.Project.Tests.Pages.Provider
{
    public class ProviderApprenticeDetailsPage(ScenarioContext context) : ApprovalsBasePage(context)
    {
        ...
        private static By ChangeOptionLink => By.XPath("/html/body/div[2]/main/div/div/table[3]/tbody/tr[7]/td[2]/a");
        private static By ChangeVersionLink => By.XPath("/html/body/div[2]/main/div/div/table[3]/tbody/tr[6]/td[2]/a");
