...
namespace SFA.DAS.Approvals.UITests.Project.Tests.Pages.Provider
{
    public class ProviderAppsIndicativeEarningsReportPage : ApprovalsBasePage
    {
        ...
        private static By ExpectedTotalOnProgrammeEarningsHeading => By.XPath($"//h2[text()='Expected total on-programme earnings in current academic year ({DateTime.Now.Year} to {DateTime.Now.Year+1})']");
        ...
        private static By DownloadSumaryReportHeading => By.XPath("//h2[text()='Download summary report']");
        ...
        public ProviderAppsIndicativeEarningsReportPage(ScenarioContext context) : base(context) => VerifyPage();
        ...
        public void ValidateUIElementsOnPage()
        {
            ...
            Assert.IsTrue(pageInteractionHelper.IsElementDisplayed(DownloadSumaryReportHeading), "Download sumary report heading not displayed");
