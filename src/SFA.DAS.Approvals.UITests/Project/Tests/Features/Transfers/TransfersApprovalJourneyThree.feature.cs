...
namespace SFA.DAS.Approvals.UITests.Project.Tests.Features.Transfers
{
    ...
    [NUnit.Framework.DescriptionAttribute("TransfersApprovalJourneyThree")]
    public partial class TransfersApprovalJourneyThreeFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "TransfersApprovalJourneyThree.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "TransfersApprovalJourneyThree", "A short summary of the feature", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Creating Cohort rejected by Sender and then approved by all 3 parties")]
        ...
        public virtual void CreatingCohortRejectedBySenderAndThenApprovedByAll3Parties()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Creating Cohort rejected by Sender and then approved by all 3 parties", null, new string[] {
                        "regression",
                        "transfersscenarios",
                        "liveapprentice",
                        "transfersfunds"});
