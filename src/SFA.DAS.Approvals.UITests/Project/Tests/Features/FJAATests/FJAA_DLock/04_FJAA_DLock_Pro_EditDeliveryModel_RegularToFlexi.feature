@approvals
Feature: 04_FJAA_DLock_Pro_EditDeliveryModel_RegularToFlexi
...
changing DM from Regular to Flexi and submits changes for approval.
FJAA Employer then views changes and approves, later verifying that changes have been saved.

@regression
@flexi-job
@e2escenarios
Scenario: 04_FJAA_DLock_Pro_EditDeliveryModel_RegularToFlexi
