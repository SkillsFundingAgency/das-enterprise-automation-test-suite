...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-GB"), "DH_01_ReservesFundingToAddAnApprentices", "As a Non Levy Employer, I want to reserves funding form dynamic homepage\r\nSo that" +
                    ", I can add an apprentice", ProgrammingLanguage.CSharp, new string[] {
                        "dynamicHomePage"});
        ...
        [NUnit.Framework.DescriptionAttribute("DH_01 Employer reserves funding from homepage journey")]
        [NUnit.Framework.CategoryAttribute("regression")]
        [NUnit.Framework.CategoryAttribute("dynamichomepage")]
        [NUnit.Framework.CategoryAttribute("addpayedetails")]
        public virtual void DH_01EmployerReservesFundingFromHomepageJourney()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("DH_01 Employer reserves funding from homepage journey", null, new string[] {
                        "regression",
                        "dynamichomepage",
                        "addpayedetails"});
#line 9
