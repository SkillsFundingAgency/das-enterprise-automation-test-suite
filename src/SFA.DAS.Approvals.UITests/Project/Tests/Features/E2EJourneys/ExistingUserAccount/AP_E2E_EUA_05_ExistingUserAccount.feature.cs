...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("AP_E2E_EUA_05_ExistingUserAccount Employer verifies field entry before adding app" +
            "rentice")]
        ...
        public void AP_E2E_EUA_05_ExistingUserAccountEmployerVerifiesFieldEntryBeforeAddingApprentice()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("AP_E2E_EUA_05_ExistingUserAccount Employer verifies field entry before adding app" +
                    "rentice", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
                ...
                table2.AddRow(new string[] {
                            ...
                            "Enter a last name that is not longer than 100 characters"});
#line 11
testRunner.When("Provider add an apprentice uses details from below to create bulkupload", ((string)(null)), table2, "When ");
#line hidden
            }
