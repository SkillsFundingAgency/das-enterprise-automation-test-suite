...
Scenario: AP_COP_01_Change Of Provider_HappyPath
	...
	And previous Provider should not be able to start CoE on the old record when CoP is inflight
	...
	And previous Provider should not be able to start CoE on the old record after Successful CoP
