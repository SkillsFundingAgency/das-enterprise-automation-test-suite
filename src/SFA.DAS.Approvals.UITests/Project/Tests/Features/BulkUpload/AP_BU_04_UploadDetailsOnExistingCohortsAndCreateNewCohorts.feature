...
Scenario: AP_BU_04_Upload Details On Existing Cohorts And Create New Cohorts
	...
	When Provider uses BulkUpload to add 2 apprentice details into existing cohort
	Then Correct Information is displayed on review apprentices details pageV2
	And Provider approves the cohorts and send them to employer to approveV2
