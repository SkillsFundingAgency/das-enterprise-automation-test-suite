...
Scenario: AP_BU_06_Validation Rules
 ...
 | CohortRef length > 20	| ABC999	| valid			| valid		| valid		 | valid	  | valid		| valid			| valid	  | valid		| valid		|valid		 | valid	| valid					| You must enter a valid Cohort Ref	|
 ...
 | CohortUlnEmailDoB 		| 9XZY99	| valid			| 171649120 | valid      | 2021-05-09 | valid		|  com@.com			| valid	  | 2021-03-03	| 2021-02   | valid		 | valid	| valid					| You must enter a valid Cohort Ref\nEnter a 10-digit unique learner number\nEnter a valid email address\nEnter an end date that is after the start date|
