...
Scenario: AP_BU_06_Validation Rules
 ...
 | FamilyName > 100			| valid	    |valid	    |valid	| FamilyNameFamilyNameFamilyNameFamilyNameFamilyNameFamilyNameFamilyNameFamilyNameFamilyNameFamilyNameFamilyName		|valid		|valid			|valid			|valid		|valid		|valid		|valid		| valid		| valid			| Enter a last name that is not longer than 100 characters	|
 | GivenNameEmpty			| valid	    |valid	    |valid	| 		|valid		|valid			|valid			|valid		|valid		|valid		|valid		| valid		| valid			| Last name must be entered	|
 | GivenName > 100			| valid	    |valid	    |valid	| GivenNameGivenNameGivenNameGivenNameGivenNameGivenNameGivenNameGivenNameGivenNamesGivenNamesGivenNamesGivenNames		|valid		|valid			|valid			|valid		|valid		|valid		|valid		| valid		| valid			| Enter a last name that is not longer than 100 characters	|
 ...
 #| CohortUlnEmailDoB 		| MKRK7VMKRK7VMKRK7VPJ1     | valid     | 171649120 | valid      | 2021-05-09      | valid       |  X@Y        | valid   | 2021-03-03     | 2021-02   | valid      | valid    | valid       |  You must enter a valid Cohort Ref\nEnter a 10-digit unique learner number\nEnter a valid email address\nEnter an end date that is after the start date |
