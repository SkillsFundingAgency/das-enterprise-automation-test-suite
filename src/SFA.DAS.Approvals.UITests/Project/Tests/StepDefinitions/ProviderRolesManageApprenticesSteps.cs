...
namespace SFA.DAS.Approvals.UITests.Project.Tests.StepDefinitions
{
    ...
    public class ProviderRolesManageApprenticesSteps(ScenarioContext context)
    {
        ...
        private ProviderManageYourLearnerPage GoToProviderManageYourApprenticePage() => _providerStepsHelper.NavigateToProviderHomePage().GoToProviderManageYourApprenticePage();
