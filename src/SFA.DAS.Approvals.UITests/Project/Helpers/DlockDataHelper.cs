...
namespace SFA.DAS.Approvals.UITests.Project.Helpers
{
    public partial class DlockDataHelper
    {
        ...
        public DlockDataHelper(ApprovalsConfig approvalsConfig, ApprenticeDataHelper dataHelper, ApprenticeCourseDataHelper coursedataHelper)
        {
        ...
        public int GetDatalocksResolvedStatus()
        {
            ...
            List<object[]> responseData = SqlDatabaseConnectionHelper.ReadDataFromDataBase(sqlQueryToGetDatalockResolvedStatus, _connectionString);
        ...
        private void SubmitILRMismatch(string type)
        {
            ...
            {
                { "@MaxDataLockEventId", Convert.ToString(DataLockEventId.GetMaxDataLockEventId(_connectionString)) },
