...
Scenario: FATV2_SAWCINO_03_Search Training Where Course Is Not Offered
	...
	When the User selects 10000415 from the list
	And enters the location Exeter, Devon
	Then 'This training provider does not offer this course at the apprenticeship location' message is displayed