...
public class CommitmentsTrainingProviderHistorySteps : CommitmentsCohortDetailsBaseSteps
{
    ...
    public void ThenTheULNDetailsPageIsDisplayedWithTrainingProviderHistory() => new UlnDetailsPageWithTrainingProviderHistory(_context).ClickTrainingProviderHistoryTab();
