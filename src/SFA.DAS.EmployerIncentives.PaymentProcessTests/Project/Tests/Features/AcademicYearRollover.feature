...
Scenario: AC1 -  trigger learning stopped for current Academic Year
	...
	And the end date of the most recent price episode is before the current period census date
...
Scenario: AC2 -  trigger learning stopped for previous Academic Year
	Given an existing Phase1 apprenticeship incentive
