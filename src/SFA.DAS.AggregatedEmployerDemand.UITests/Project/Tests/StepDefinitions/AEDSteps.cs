...
public class AedSteps
{
    ...
    public void GivenTheUserSelectsShareInterestWithFindingATrainingProvider() => _getHelpWithFindingATrainingProviderPage = AedStepsHelper.GetHelpWithFindingATrainingProviderViaShortlistPage(_aedIndexPage);
