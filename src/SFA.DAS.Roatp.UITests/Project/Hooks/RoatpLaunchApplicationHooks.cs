...
namespace SFA.DAS.Roatp.UITests.Project.Hooks
{
    ...
    public class RoatpLaunchApplicationHooks : RoatpBaseHooks
    {
        ...
        {
            if (_tags.Any(x => x == "roatpapply" || x == "roatpapplycreateaccount" || x == "roatpfulle2eviaapply" || x == "roatpapplyinprogressapplication" || x == "roatpapplychangeukprn" || x == "roatpapplytestdataprep")) GoToUrl(UrlConfig.Apply_BaseUrl);
