...
{
    public class ImprovementsUsingProcessForEvaluatingPage : RoatpApplyBasePage
    {
        ...
        public ImprovementsUsingProcessForEvaluatingPage(ScenarioContext context) : base(context) => VerifyPage();
