...
namespace SFA.DAS.Roatp.UITests.Project.Tests.Pages.RoatpApply
{
    ...
    {
        #region Questions
        private string Yourorganisation => "1. Your organisation";
        ...
        private string FinancialEvidence => "2. Financial evidence";
        ...
        private string CriminalAndComplianceChecks => "3. Criminal and compliance checks";
        ...
        private string ProtectingYourApprentices => "4. Protecting your apprentices";
        ...
        private string ReadinessToEngage => "5. Readiness to engage";
        ...
        // TODO: Add implementation for access/verify/complete etc
        ...
        private string EvaluatingApprenticeshipTraining => "8. Evaluating apprenticeship training";
        ...
        private string Finish => "9. Finish";
