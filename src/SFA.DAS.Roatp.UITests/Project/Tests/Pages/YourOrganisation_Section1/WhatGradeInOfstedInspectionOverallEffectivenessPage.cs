...
{
    public class WhatGradeInOfstedInspectionOverallEffectivenessPage : RoatpBasePage
    {
        ...
        public ApplicationOverviewPage SelecForoverallEffectivenessGradeRequiresImprovementAndContinue()
        {
