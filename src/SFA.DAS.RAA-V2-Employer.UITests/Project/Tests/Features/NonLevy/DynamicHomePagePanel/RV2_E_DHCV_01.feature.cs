...
namespace SFA.DAS.RAA_V2_Employer.UITests.Project.Tests.Features.NonLevy.DynamicHomePagePanel
{
    ...
    [NUnit.Framework.DescriptionAttribute("RV2_E_DHCV_01")]
    public partial class RV2_E_DHCV_01Feature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "RV2_E_DHCV_01.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-GB"), "RV2_E_DHCV_01", "\tAs a Non Levy Employer, I want to add a vacancy after reserves funding from dyna" +
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("RV2_E_DHCV_01 Employer creates vacancy from dynamic homepage journey, approve and" +
            " close vacancy")]
        ...
        [NUnit.Framework.CategoryAttribute("approvalsdatahelpers")]
        public virtual void RV2_E_DHCV_01EmployerCreatesVacancyFromDynamicHomepageJourneyApproveAndCloseVacancy()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("RV2_E_DHCV_01 Employer creates vacancy from dynamic homepage journey, approve and" +
                    " close vacancy", null, new string[] {
                        "raa-v2",
                        "raa-v2e",
                        "regression",
                        "addpayedetails",
...
#line 21
 testRunner.Then("the vacancy details is displayed on the Dynamic home page with Status \'CLOSED\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 22
 testRunner.And("the Employer is able to go back to the Recruitment after clicking \'application\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
