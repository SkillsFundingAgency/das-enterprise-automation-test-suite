...
Scenario: Employer enters valid employment start date for phase 2 and a phase 3 apprenticeships
	...
	And the Employer enters an employment start date of '30/09/2021' for the first learner - eligible = 'true'
    And the Employer enters an employment start date of '01/10/2021' for the second learner - eligible = 'true'
...
Scenario: Employer enters an invalid employment start date for phase 2 and a phase 3 apprenticeships
	...
	And the Provider approves the apprenticeship request
	And the Employer selects those apprentices on an incentive application
	And the Employer enters an employment start date of '31/03/2021' for the first learner - eligible = 'false'
    And the Employer enters an employment start date of '01/02/2022' for the second learner - eligible = 'false'
	When the Employer selects Continue
...
Scenario: Employer enters an employment start date in the phase 3 window for a phase 2 commitment
	...
	And the Employer enters an employment start date of '01/10/2021' for the first learner - eligible = 'false'
    When the Employer selects Continue
	Then the Ineligible Employment Start Date page is displayed
	And the Cancel Application button is displayed
...
Scenario: Employer enters an invalid  and valid employment start date in the phase 3 window for a phase 3 commitment
	...
	And the Provider approves the apprenticeship request
	And the Employer selects the apprentice on an incentive application
	And the Employer enters an employment start date of '30/09/21' for the first learner - eligible = 'false'
    And the Employer enters an employment start date of '01/10/21 ' for the second learner - eligible = 'true'
	When the Employer selects Continue
    Then the Ineligible Employment Start Date page is displayed
	And the Continue Application button is displayed
...
Scenario: Employer enters an invalid  and valid employment start date in the phase 2 window for a phase 2 commitment
	...
	And the Provider approves the apprenticeship request
	And the Employer selects the apprentice on an incentive application
	And the Employer enters an employment start date of '30/9/21' for the first learner - eligible = 'true'
    And the Employer enters an employment start date of '01/12/21 ' for the second learner - eligible = 'false'
	When the Employer selects Continue
    Then the Ineligible Employment Start Date page is displayed
	And the Continue Application button is displayed