...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Employer enters an invalid  and valid employment start date in the phase 2 window" +
            " for a phase 2 commitment")]
        [NUnit.Framework.CategoryAttribute("regression")]
        [NUnit.Framework.CategoryAttribute("employerincentives")]
        [NUnit.Framework.CategoryAttribute("addlevyfunds")]
        public virtual void EmployerEntersAnInvalidAndValidEmploymentStartDateInThePhase2WindowForAPhase2Commitment()
        {
            string[] tagsOfScenario = new string[] {
                    "regression",
                    "employerincentives",
