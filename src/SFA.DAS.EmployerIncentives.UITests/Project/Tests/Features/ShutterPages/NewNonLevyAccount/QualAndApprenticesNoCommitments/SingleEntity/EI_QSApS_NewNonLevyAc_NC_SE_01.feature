Feature: EI_QSApS_NewNonLevyAc_NC_SE_01

@regression
@nonlevypaye
@employerincentives
Scenario: EI_QSApS_NewNonLevyAc_NC_SE_01_Validate Shutter pages for New Non Levy Account with One legal entity and No Commitments
