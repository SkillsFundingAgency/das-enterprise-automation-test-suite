...
@addpayedetails
Scenario: EI_E2E_Create A LevyAccount and add some Commitments
	Given an Employer creates a Levy Account and Signs the Agreement
	When the Employer adds 5 apprentices Aged16to24 as of 01AUG2020 with start date as Month 8 and Year 2020
