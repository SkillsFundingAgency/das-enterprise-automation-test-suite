Feature: RP_Outcome_UnSuccessful_Appeals_01
...
And verify the Application successful page is displayed for Appealead Application
...
@newroatpadmin
@regression
Scenario: RP_AD_OUTCOME_Appeals_01B Existing provider Complete Outcome of a Company type Application via Main provider route Appeal_Unsuccessful Journey	
Given the Main provider is already on the RoATP register as Active
And the admin navigates to the Dashboard
And the application with PASS outcome is ready to be assessed
When the oversight user overturns gateway and moderation outcome
...
@newroatpadmin
@regression
Scenario: RP_AD_OUTCOME_Appeals_01C Existing provider Complete Outcome of a Company type Application via Main provider route Appeal_InProgress_UnSuccessful Journey	
Given the Main provider is already on the RoATP register as Active
And the admin navigates to the Dashboard
And the application with PASS outcome is ready to be assessed
When the oversight user overturns gateway and moderation outcome
...
@newroatpadmin
@regression
Scenario: RP_AD_OUTCOME_Appeals_01D Existing provider Complete Outcome of a Company type Application via Main provider route Appeal_InProgress_Successful_FitnessForFunding	Journey
Given the Main provider is already on the RoATP register as Active
And the admin navigates to the Dashboard
And the application with PASS outcome is ready to be assessed
When the oversight user overturns gateway and moderation outcome
...
@newroatpadmin
@regression
Scenario: RP_AD_OUTCOME_Appeals_01E New Provider Complete Outcome of a Company type Application via Main provider route Appeals_Unsuccessful Journey
...
@newroatpadmin
@regression
Scenario: RP_AD_OUTCOME_Appeals_01F New Provider Complete Outcome of a Company type Application via Main provider route Appeals_Successful Journey
Given the admin lands on the Dashboard
And the application with PASS outcome is ready to be assessed	
When the oversight user overturns gateway and moderation outcome
And the oversight user selects the overall application outcome as Unsuccessful
...
@newroatpadmin
@regression
Scenario: RP_AD_OUTCOME_Appeals_01G New Provider Complete Outcome of a Company type Application via Main provider route Appeals_Inprogress_Successful Journey
Given the admin lands on the Dashboard
And the application with PASS outcome is ready to be assessed	
When the oversight user overturns gateway and moderation outcome
And the oversight user selects the overall application outcome as Unsuccessful
...
@newroatpadmin
@regression
Scenario: RP_AD_OUTCOME_Appeals_01H New Provider Complete Outcome of a Company type Application via Main provider route Appeals_Inprogress_UnSuccessful Journey
Given the admin lands on the Dashboard
And the application with PASS outcome is ready to be assessed	
When the oversight user overturns gateway and moderation outcome
And the oversight user selects the overall application outcome as Unsuccessful
