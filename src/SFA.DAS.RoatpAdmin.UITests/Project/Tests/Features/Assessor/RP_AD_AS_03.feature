...
@newroatpadmin
@regression
Scenario: RP_AD_AS_03 Assess a Soletrader type Application via Supporting provider route existing provider
	When the Assessor1 is on the RoATP assessor applications dashboard
	And selects the Supporting Provider Route For Existing Provider application
