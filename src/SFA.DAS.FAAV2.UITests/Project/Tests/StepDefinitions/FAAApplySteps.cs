...
public class FAAApplySteps(ScenarioContext context)
{
    ...
    public void TheApplicantCanApplyForAVacancyInFAA() => _faaStepsHelper.ApplyForFirstVacancy(true, true, true, true, true, true).PreviewApplication().SubmitApplication();
}