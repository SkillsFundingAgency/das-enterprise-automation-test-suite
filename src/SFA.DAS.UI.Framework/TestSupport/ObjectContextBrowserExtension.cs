...
namespace SFA.DAS.UI.Framework.TestSupport
{
    public static class ObjectContextBrowserExtension
    {
        ...
        public static void SetFireFoxDriverLocation(this ObjectContext objectContext, string value) => objectContext.Set(FireFoxDriverLocation, value);
        public static string GetFireFoxDriverLocation(this ObjectContext objectContext) => objectContext.Get(FireFoxDriverLocation);
        public static void SetChromeDriverLocation(this ObjectContext objectContext, string value) => objectContext.Set(ChromeDriverLocation, value);
        public static string GetChromeDriverLocation(this ObjectContext objectContext) => objectContext.Get(ChromeDriverLocation);
        public static void SetIeDriverLocation(this ObjectContext objectContext, string value) => objectContext.Set(IeDriverLocation, value);
