...
public static class UrlConfig
{
    ...
    public static string FAAV2_BaseUrl => $"https://{(EnvironmentConfig.EnvironmentName).ToLower()}-findapprenticeship.apprenticeships.education.gov.uk/apprenticeshipsearch";
