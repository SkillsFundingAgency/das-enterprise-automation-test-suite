...
public static class UrlConfig
{
    ...
    private static string FAAV2_BaseUrl => $"https://{(EnvironmentConfig.EnvironmentName).ToLower()}-findapprenticeship.apprenticeships.education.gov.uk/";

    public static string FAAV2_AppSearch => $"{FAAV2_BaseUrl}apprenticeshipsearch";

    public static string FAAV2_Vacancy => $"{FAAV2_BaseUrl}apprenticeship";
