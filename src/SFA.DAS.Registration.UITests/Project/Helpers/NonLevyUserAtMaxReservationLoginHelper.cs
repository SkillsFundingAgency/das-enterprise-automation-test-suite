...
{
    public class NonLevyUserAtMaxReservationLoginHelper(ScenarioContext context, NonLevyUserAtMaxReservationLimit multipleAccountUser) : EmployerPortalLoginHelper(context)
    {
