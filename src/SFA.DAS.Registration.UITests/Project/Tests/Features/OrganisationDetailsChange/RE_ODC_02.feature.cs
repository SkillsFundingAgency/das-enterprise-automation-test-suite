...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("RE_ODC_02_Create an Employer Account with Charity Type Org")]
        [NUnit.Framework.CategoryAttribute("regression")]
        [NUnit.Framework.CategoryAttribute("registration")]
        [NUnit.Framework.CategoryAttribute("addpayedetails")]
        public virtual void RE_ODC_02_CreateAnEmployerAccountWithCharityTypeOrg()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("RE_ODC_02_Create an Employer Account with Charity Type Org", null, new string[] {
                        "regression",
                        "registration",
                        "addpayedetails"});
#line 6
