...
#line hidden
        ...
        public virtual void RE_TL_01_CreateAccountByCompletingOneTaskAtATime(string canAddPAYE, string canSetAccountName, string canSignEmployerAgreement, string canAddTrainingProvider, string canGrantProviderPermissions, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("CanAddPAYE", canAddPAYE);
...
#line hidden
#line 16
 testRunner.When(string.Format("user {0} add PAYE details", canAddPAYE), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 17
 testRunner.When(string.Format("user {0} set account name", canSetAccountName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 18
 testRunner.When(string.Format("user {0} accept the employer agreement", canSignEmployerAgreement), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 19
 testRunner.When(string.Format("user {0} add training provider", canAddTrainingProvider), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 20
 testRunner.When(string.Format("user {0} grant training provider permissions", canGrantProviderPermissions), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 21
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("RE_TL_01_Create Account by completing one task at a time: can")]
        [NUnit.Framework.CategoryAttribute("regression")]
        [NUnit.Framework.CategoryAttribute("registration")]
        [NUnit.Framework.CategoryAttribute("addnonlevyfunds")]
        public void RE_TL_01_CreateAccountByCompletingOneTaskAtATime_Can()
        {
#line 10
this.RE_TL_01_CreateAccountByCompletingOneTaskAtATime("can", "cannot", "cannot", "cannot", "cannot", ((string[])(null)));
#line hidden
        }
    }
}
