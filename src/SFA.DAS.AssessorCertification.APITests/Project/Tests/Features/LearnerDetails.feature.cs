...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-GB"), "Project/Tests/Features", "LearnerDetails", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void VerifyLearnerDetailsHeldByTheAssessorService(string testCaseId, string method, string endpoint, string payload, string responseStatus, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify Learner Details held by the Assessor Service", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
