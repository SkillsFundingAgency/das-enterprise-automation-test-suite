...
namespace SFA.DAS.AssessorCertification.APITests.Project.Tests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("RecordAssessmentOutcomes")]
    public partial class RecordAssessmentOutcomesFeature
    {
...
#line 1 "RecordAssessmentOutcomes.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-GB"), "Project/Tests/Features", "RecordAssessmentOutcomes", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        public virtual void VerifyCreateEPARecord(string testCaseId, string method, string endpoint, string payload, string responseStatus, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify Create EPA Record", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
        ...
        public void VerifyCreateEPARecord_CreateEPARecord001()
        {
#line 6
...
#line hidden
        ...
        public virtual void VerifyUpdateEPARecord(string testCaseId, string method, string endpoint, string payload, string responseStatus, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("Payload", payload);
            argumentsOfScenario.Add("ResponseStatus", responseStatus);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify Update EPA Record", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 19
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("regression")]
        [NUnit.Framework.CategoryAttribute("assessorcertificationapi")]
        public void VerifyUpdateEPARecord_UpdateEPARecord001()
        {
#line 19
...
#line hidden
        ...
        public virtual void VerifyDeleteEPARecord(string testCaseId, string method, string endpoint, string payload, string responseStatus, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("Payload", payload);
            argumentsOfScenario.Add("ResponseStatus", responseStatus);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify Delete EPA Record", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 32
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
            ...
            else
            {
                this.ScenarioStart();
#line 33
 testRunner.Given("the user prepares delete request with uln 1000809117", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 34
 testRunner.When(string.Format("the user sends {0} request to {1} with payload {2}", method, endpoint, payload), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("regression")]
        [NUnit.Framework.CategoryAttribute("assessorcertificationapi")]
        public void VerifyDeleteEPARecord_DeleteEPARecord001()
        {
#line 32
this.VerifyDeleteEPARecord("DeleteEPARecord001", "DELETE", "/api/v1/epa/1000809117/Name1000809117/91/00040171", "", "NoContent", ((string[])(null)));
#line hidden
        }
    }
}
