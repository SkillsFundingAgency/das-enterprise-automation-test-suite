...
public abstract class AS_WhenDoYouWantToWithdrawBasePage : EPAO_BasePage
{
    ...
    #region Locators
    private static By DayText => By.XPath("//label[contains(text(), 'Day')]/following-sibling::input");
    private static By MonthText => By.XPath("//label[contains(text(), 'Month')]/following-sibling::input");
    private static By YearText => By.XPath("//label[contains(text(), 'Year')]/following-sibling::input");
    #endregion
