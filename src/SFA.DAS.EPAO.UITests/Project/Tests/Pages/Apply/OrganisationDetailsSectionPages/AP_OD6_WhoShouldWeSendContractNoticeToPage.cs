...
{
    public class AP_OD6_WhoShouldWeSendContractNoticeToPage : EPAO_BasePage
    {
        ...
        public AP_OD6_WhoShouldWeSendContractNoticeToPage(ScenarioContext context) : base(context)
        {
            _context = context;
            VerifyPage();
        }

        public AP_OD6_WhoShouldWeSendContractNoticeToPage EnterContactDetailsAndClickContinueInWhoShouldWeSendTheContractNoticeToPage()
        {
