...
namespace SFA.DAS.EPAO.UITests.Project.Tests.StepDefinitions.EPAOWithdrawalStepDefs
{
    ...
    public class EPAOWithdrawalSteps : EPAOBaseSteps
    {
        ...
        public void GivenStartsTheJourneyToWithdrawAStandard() => _ePAOWithdrawalHelper.StartOfStandardWithdrawalJourney();

        [When(@"completes the standard withdrawal notification questions")]
        public void WhenCompletesTheStandardWithdrawalNotificationQuestions() => _ePAOWithdrawalHelper.StandardApplicationFinalJourney();
        ...
        public void GivenStartsTheJourneyToWithdrawFromTheRegister() => _ePAOWithdrawalHelper.StartOfRegisterWithdrawalJourney();
        ...
        public void CompletesTheRegisterWithdrawalNotificationQuestions() => _ePAOWithdrawalHelper.RegisterWithdrawalQuestions();
        ...
        public void TheWithdrawalUserReturnsToDashboard() => ePAOHomePageHelper.GoToEpaoAssessmentLandingPage(true).AlreadyLoginGoToLoggedInHomePage();
