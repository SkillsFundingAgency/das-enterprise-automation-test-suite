...
@regression
@epaoca1standard2version0option
Scenario: EPAO_RG_CA_03B - Certify an Apprentice as Fail - 1 Standard - multiple Version - No Options
	Given the Assessor User is logged into Assessment Service Application
...
@regression
@epaoca1standard2version0option
Scenario: EPAO_RG_CA_03C - Certify an Apprentice as Fail to Pass - 1 Standard - multiple Version - No Options
	Given the Assessor User is logged into Assessment Service Application
	When the User certifies an Apprentice as 'fail'
	Then the User can navigates to record another grade
