...
@regression
@epaoca2standard2version0option
Scenario: EPAO_RG_CA_07B - Certify an Apprentice as Fail - multiple Standard - multiple Version - No Options
	Given the Assessor User is logged into Assessment Service Application
...
@regression
@epaoca2standard2version0option
Scenario: EPAO_RG_CA_07C - Certify an Apprentice as Fail to Pass - multiple Standard - multiple Version - No Options
	Given the Assessor User is logged into Assessment Service Application
	When the User certifies an Apprentice as 'fail'
	Then the User can navigates to record another grade
