...
@regression
@epaoca2standard2version1option
Scenario: EPAO_RG_CA_08B - Certify an Apprentice as Fail - Multiple Standard - 1 Version - No Options
	Given the Assessor User is logged into Assessment Service Application
...
@regression
@epaoca2standard2version1option
Scenario: EPAO_RG_CA_08C - Certify an Apprentice as Fail to Pass - Multiple Standard - 1 Version - No Options
	Given the Assessor User is logged into Assessment Service Application
	When the User certifies an Apprentice as 'fail'
	Then the User can navigates to record another grade
