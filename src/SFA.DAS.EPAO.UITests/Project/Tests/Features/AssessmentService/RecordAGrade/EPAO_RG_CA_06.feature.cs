...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("regression")]
        [NUnit.Framework.CategoryAttribute("epaoca2standard1version1option")]
        public virtual void EPAO_RG_CA_06B_CertifyAnApprenticeAsFail_MultipleStandard_1Version_NoOptions()
        {
            string[] tagsOfScenario = new string[] {
                    "epao",
                    "recordagrade",
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("regression")]
        [NUnit.Framework.CategoryAttribute("epaoca2standard1version1option")]
        public virtual void EPAO_RG_CA_06C_CertifyAnApprenticeAsFailToPass_MultipleStandard_1Version_NoOptions()
        {
            string[] tagsOfScenario = new string[] {
                    "epao",
                    "recordagrade",
