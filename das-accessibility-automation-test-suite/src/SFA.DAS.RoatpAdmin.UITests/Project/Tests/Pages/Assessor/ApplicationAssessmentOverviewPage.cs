...
{
    public partial class ApplicationAssessmentOverviewPage(ScenarioContext context) : AssessorBasePage(context)
    {
        ...
        #region Section-6
        private static string Section6_Link1 => "Ready for moderation";
        #endregion
    }
}
